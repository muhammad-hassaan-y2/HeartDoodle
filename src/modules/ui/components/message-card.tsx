...
const FragmentCard=  ({
    ...
    onFragmentClick,
        ...
        return (
            <button
             className={cn(
                "flex items-start tect-start gap-2 border rounded-lg bg-muted w-fit p-3 hover:bg-secondary transition-colors",
        ...
        <div className={cn(
           ...
           <div className="flex items-center gap-2 pl-2 mb-2">
            <Image 
             ...
             className="shrink-0"
             />
              <span className="text-sm font-medium">Doodle</span>
